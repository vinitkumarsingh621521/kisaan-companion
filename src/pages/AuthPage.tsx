        ...
        <div className="glass-card p-8">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-2 mb-3">
              <img src={logo} alt="KrishiMitra" className="h-10 w-10" />
              <span className="font-display font-bold text-2xl text-foreground">
                Krishi<span className="text-primary">Mitra</span>
              </span>
            </div>
            <p className="text-muted-foreground text-sm">
              {isLogin ? "Welcome back, farmer! 🙏" : "Join the farming revolution 🌾"}
            </p>
          </div>
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <Button type="submit" className="w-full gradient-primary border-0 text-primary-foreground h-11" disabled={loading}>
              {loading ? <Loader2 className="h-4 w-4 animate-spin mr-2" /> : <Sprout className="h-4 w-4 mr-2" />}
