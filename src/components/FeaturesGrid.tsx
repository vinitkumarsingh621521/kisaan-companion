...
const features = [
  ...
  { icon: Map, title: "Field Mapper", desc: "GPS-based farm mapping with crop zone planning. Uses satellite imagery to create detailed farm maps with soil quality overlays.", color: "bg-krishi-green-light text-krishi-green", link: null },
  ...
  { icon: Smartphone, title: "Works Offline", desc: "Full functionality in low-connectivity rural areas. Syncs data when connection is restored. PWA-ready for mobile.", color: "bg-muted text-muted-foreground", link: null },
  { icon: Award, title: "Gamification", desc: "Earn badges for sustainable farming practices", color: "bg-krishi-gold-light text-krishi-gold", link: "/community" },
  { icon: FileText, title: "Smart Reports", desc: "Auto-generated farm reports for loans, insurance, and government subsidy applications. Export as PDF.", color: "bg-krishi-sky-light text-krishi-sky", link: null },
  { icon: Satellite, title: "Satellite View", desc: "5-year farm evolution using Bhuvan/Sentinel imagery. Track NDVI, crop health, and land-use changes over time.", color: "bg-accent text-accent-foreground", link: null },
  { icon: Bot, title: "IoT Integration", desc: "Connect soil sensors for real-time NPK, pH, and moisture data. Supports popular Indian IoT devices.", color: "bg-krishi-green-light text-krishi-green", link: null },
